...
Ainsi le second classifieur est plus efficace que le premier du fait d'une meilleure précision. Nous en avons donc déduit qu'il était plus intéréssant de classer les mails en fonction de leur contenu que par rapport à leur taille.\\
...
Classifieur en fonction de la longueur\\
\includegraphics[scale=0.5]{Figure_2}\\
Classifieur en fonction du contenu\\
